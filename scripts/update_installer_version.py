...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Trippy Demo Installer\n"
      else:
        line="OutputBaseFilename=Trippy Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Trippy Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Trippy installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Trippy Demo installer\n"
     else:
       line="SetupWindowTitle=Trippy installer\n"
