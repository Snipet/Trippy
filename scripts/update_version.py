...
def main():
  ...
  plistpath = scriptpath + "/resources/Trippy-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Trippy-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Trippy-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Trippy-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Trippy-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Trippy.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Trippy.iss",inplace=1):
